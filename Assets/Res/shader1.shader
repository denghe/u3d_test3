...
Shader "shader1"
{
    ...
    Properties
    {
		...
		_UVTiling_Thickness_Speed("UVTiling_Thickness_Speed", Vector) = (1,1,-12,-5)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 _UVTiling_Thickness_Speed;
			float3 _Color;
			CBUFFER_END
			...
			half4 frag( VertexOutput IN   ) : SV_TARGET
			{
				...
				float2 appendResult49 = (float2(_UVTiling_Thickness_Speed.x , _UVTiling_Thickness_Speed.y));
				float mulTime46 = _TimeParameters.x * _UVTiling_Thickness_Speed.w;
				float2 appendResult45 = (float2(mulTime46 , 0.0));
				float2 texCoord41 = IN.texCoord0.xy * appendResult49 + appendResult45;
				float simplePerlin2D39 = snoise( texCoord41 );
				...
				surfaceDescription.Alpha = ( simplePerlin2D39 * exp( ( abs( ( texCoord8.y - 0.5 ) ) * _UVTiling_Thickness_Speed.z ) ) );
        ...
        Pass
        {
			...
			half4 frag( VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime46 = _TimeParameters.x * _UVTiling_Thickness_Speed.w;
				float2 appendResult45 = (float2(mulTime46 , 0.0));
				float2 texCoord41 = IN.ase_texcoord2.xy * appendResult49 + appendResult45;
				float simplePerlin2D39 = snoise( texCoord41 );
				simplePerlin2D39 = simplePerlin2D39*0.5 + 0.5;
        ...
        Pass
        {
			...
			half4 frag( VertexOutput IN ) : SV_TARGET
			{
				...
				float mulTime46 = _TimeParameters.x * _UVTiling_Thickness_Speed.w;
				float2 appendResult45 = (float2(mulTime46 , 0.0));
				float2 texCoord41 = IN.ase_texcoord.xy * appendResult49 + appendResult45;
				float simplePerlin2D39 = snoise( texCoord41 );
				simplePerlin2D39 = simplePerlin2D39*0.5 + 0.5;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-464,-528;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;48;-528,-784;Inherit;False;Property;_UVTiling_Thickness_Speed;UVTiling_Thickness_Speed;1;0;Create;True;0;0;0;False;0;False;1,1,-12,-5;1,1,-12,-5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;10;-208,-480;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;46;-224,-640;Inherit;False;1;0;FLOAT;-5;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;45;-16,-656;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.AbsOpNode;11;16,-480;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;49;-16,-784;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;41;160,-736;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;208,-480;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;39;400,-736;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ExpOpNode;26;448,-480;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;656,-624;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;29;656,-368;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;0;False;0;False;2.311647,0,3.798742,0;8,2.638743,9.172773,1;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=E5784083DF761478B9C03A91FF3099344DE39D56